...
func NewColorFromImageColor(c color.Color) ColorRGBA {
	nrgba := color.NRGBAModel.Convert(c).(color.NRGBA)
	return ColorRGBA(uint32(nrgba.A)<<24 | uint32(nrgba.R)<<16 | uint32(nrgba.G)<<8 | uint32(nrgba.B))
}
...
func NewColorFromRGBA8888(argb8888 uint32) ColorRGBA {
	return ColorRGBA(argb8888)
}
...
func (c ColorRGBA) A() uint8 {
	return uint8(c >> 24)
}
func (c ColorRGBA) R() uint8 {
	return uint8(c >> 16)
}
func (c ColorRGBA) G() uint8 {
	return uint8(c >> 8)
}
func (c ColorRGBA) B() uint8 {
	return uint8(c)
}
...
func (c ColorRGBA) ToRGB32() uint32 {
	return uint32(c.R())<<16 | uint32(c.G())<<8 | uint32(c.B())
}

func (c ColorRGBA) ToRGBA32() uint32 {
	return uint32(c)
}
