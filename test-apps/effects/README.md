...
- **Sand Simulation:** Simulating granular flow by applying gravity and collision rules to a 2D particle array with simple physics.
...
- **Vector 3D Solid:** Rendering solid 3D objects by filling in triangles or quads with flat shading and depth sorting.
- **Vector 3D Texture Mapping:** Applying 2D textures to 3D surfaces by interpolating texture coordinates across polygon faces.
